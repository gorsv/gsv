greet = "Привет, {name}, я робот, использующий нейросеть от OpenAI, чем Вам помочь?"
menu = "Главное меню"
...
text_watermark = '*Создано при помощи OpenAI*'
#img_watermark = "Создано при помощи OpenAI"
